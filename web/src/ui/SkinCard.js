...
export class SkinCard {
  ...
  createCardElement(skin) {
    ...
    // Fallback to splash CDN if local image fails
    img.onerror = () => {
      img.onerror = null; // Prevent infinite loop
      img.src = `https://ddragon.leagueoflegends.com/cdn/img/champion/splash/${skin.champion}_${skin.skin_num}.jpg`;
    };
